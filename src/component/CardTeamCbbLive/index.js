...
function CardTeamLiveComponent (props) {
    ...
    const {
        ...
        status,
        current_half,
        current_half_seconds_remaining,
        style = '',
        className,
        body,
        classNameImg,
                 ...
                 <CardBody className="w-100">
                    <div className="w-100 d-flex flex-column justify-content-center align-items-center">
                        <div className="w-100 d-flex justify-content-end align-items-end">
                            <div><span className="mr-4">1</span><span className="mr-4">2</span><span className="mr-4">E</span></div>  
                        </div>
                        <div className="w-100 team-img d-flex flex-row justify-content-start align-items-center">
                            <div className="w-100 d-flex align-items-center justify-content-between">
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    <div><span className="mr-4">{half_1_away}</span><span className="mr-4">{half_2_away}</span><span className="mr-4">{away_score}</span></div>  
                                </div>
                            </div>
                        </div>
                        <div className="w-100 team-img d-flex flex-row justify-content-start align-items-center">
                            <div className="w-100 d-flex align-items-center justify-content-between">
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    <div><span className="mr-4">{half_1_home}</span><span className="mr-4">{half_2_home}</span><span className="mr-4">{home_score}</span></div>  
                                </div>
                            </div>
                        </div>
