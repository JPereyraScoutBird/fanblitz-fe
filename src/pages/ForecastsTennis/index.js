...
import constant from "../PlayerDetailTennis/constant";
                ...
                forecastData.length ? forecastData.map(forecast => (
                  <Col xs={12} md={6}>
                    <Card 
                      ...
                      linkTitle={`${PATH_LIST.FORECAST_DETAIL_TENNIS}/${forecast.home_player}-${forecast.away_player}/${getDate2(forecast.date_z)}`}
