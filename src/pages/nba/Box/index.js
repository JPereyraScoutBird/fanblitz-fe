...
function LiveGame(props) {
  ...
  const fetchData = async () => {
      try {
        console.log("box url", `https://crfh3pd7oi.execute-api.us-east-1.amazonaws.com/qanba/nba/games/box?game_id=${gameId}`)
  ...
  const fetchDataInnings = async () => {
    try {
      const response = await axios.get(`https://crfh3pd7oi.execute-api.us-east-1.amazonaws.com/qanba/nba/games/gamescore?game_id=${gameId}`);
