...
function GamePlays(route) {
    ...
    useEffect(() => {
        const fetchData2 = async () => {
            try {
                const response = await axios.get(`https://crfh3pd7oi.execute-api.us-east-1.amazonaws.com/dev/mlb/dev/games/playbyplay?gameid=${gameId}`);
        ...
        <div style={{}}>
          <div style={{ backgroundColor: "#fff", marginTop: "2rem" }}>
              <div className="d-flex">
                  <div style={{ border: `5px solid ${constant.team_detail[gameInfo.home_team_abbr].teamColoursHex[0]}`, marginRight: "1rem"}}>
                    <img src={constant.team_detail[gameInfo.home_team_abbr].img}/>
                  </div>
                  <div className='w-100'>
          ...
          <section id="players">
            ...
            {renderTablePlays(gamePlays, constant.team_detail[gameInfo.home_team_abbr].teamColoursHex[0])}
          </section>
        </div>    
      );
    }
